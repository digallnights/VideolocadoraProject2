...
public class CadastroGenero extends JFrame {
	...
	public CadastroGenero() {
		...
		this.setIconImage(Toolkit.getDefaultToolkit().getImage(CadastroGenero.class.getResource("/view/logoico.fw.png")));
		...
		btnSalvar.setIcon(new ImageIcon(CadastroGenero.class.getResource("/view/save.png")));
		...
		btnNewButton.setIcon(new ImageIcon(CadastroGenero.class.getResource("/view/limpar.png")));
		btnNewButton.setBackground(new Color(255, 255, 255));
		btnNewButton.setBounds(307, 11, 117, 23);
		panel_1.add(btnNewButton);
		btnProgress.setBackground(new Color(255, 255, 255));
		btnProgress.setIcon(new ImageIcon(CadastroGenero.class.getResource("/view/save.png")));
